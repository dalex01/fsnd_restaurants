...
def fbconnect():
    ...
    app_id = json.loads(open(os.path.join(os.path.dirname(__file__),
                        "instance/fb_client_secrets.json"), 'r').read())['web']['app_id']
    app_secret = json.loads(open(os.path.join(os.path.dirname(__file__),
                            "instance/fb_client_secrets.json"), 'r').read())['web']['app_secret']
